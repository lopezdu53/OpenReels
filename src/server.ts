...
app.get("/api/v1/providers", async () => ({
  ...
  video: [
    ...
    { key: "vidu", label: "VIDU Q2 Turbo (~25cr/5s)" },
    { key: "vidu-q3-pro", label: "VIDU Q3 Pro (~80cr/5s)" },
    { key: "vidu-q3-fast", label: "VIDU Q3 Fast (~50cr/5s)" },
    { key: "vidu-q3-turbo", label: "VIDU Q3 Turbo (~60cr/5s)" },
    { key: "vidu-q2-pro", label: "VIDU Q2 Pro (~35cr/5s)" },
    { key: "vidu-q2-fast", label: "VIDU Q2 Fast (~20cr/5s)" },
    { key: "vidu-q2-turbo", label: "VIDU Q2 Turbo (~25cr/5s)" },
    { key: "vidu-q1", label: "VIDU Q1 (~12cr/5s)" },
    { key: "vidu-q1-classic", label: "VIDU Q1 Classic (~12cr/5s)" },
    { key: "vidu-2.0", label: "VIDU 2.0 (~10cr/5s)" },
  ],
}));
