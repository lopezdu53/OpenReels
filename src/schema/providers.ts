...
export type LLMProviderKey = "anthropic" | "openai" | "gemini" | "openrouter" | "openai-compatible" | "vivi" | "alicloud" | "atlas";
...
export type ImageProviderKey = "gemini" | "openai" | "vivi" | "alicloud" | "runpod" | "fal" | "atlas";
export type StockProviderKey = "pexels" | "pixabay";
export type VideoProviderKey = "gemini" | "fal" | "vivi" | "grok" | "runpod" | "vidu" | "vidu-q3-pro" | "vidu-q3-fast" | "vidu-q3-turbo" | "vidu-q2-pro" | "vidu-q2-fast" | "vidu-q2-turbo" | "vidu-q1" | "vidu-q1-classic" | "vidu-2.0" | "alicloud-wan-turbo" | "alicloud-wan-plus" | "atlas";
...
export interface VideoProvider {
  ...
  generate(opts: {
    ...
    /** Scene VO slice — Atlas I2V uses this for optional lip-sync / InfiniteTalk. */
    audio?: Buffer;
  }): Promise<VideoResult>;
}
